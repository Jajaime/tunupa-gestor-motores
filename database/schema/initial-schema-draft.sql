-- Initial logical schema draft.
-- This file is for review only.
-- Do not execute it as a migration yet.
...
CREATE TABLE motors (
    ...
    -- Required to validate that a device and its motor belong
    -- to the same plant.
    ...
    CONSTRAINT ck_motors_rated_current
        CHECK (rated_current IS NULL OR rated_current > 0),
